# -*- coding: utf-8 -*-
"""
analyze_sre_sem_level.py

Purpose
-------
Analyze SRE-Sem-Level raw VLM scores (semantic features injected as levels) vs human reference.

Example
-------
python src/analyze_sre_sem_level.py \
  --llm sample_data/sample_sre_sem_level_scores_raw.xlsx \
  --human sample_data/sample_human_ratings.xlsx \
  --out sample_outputs/sample_sre_sem_level_reliability_summary.xlsx
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Analyze SRE-Sem-Level raw VLM scores (semantic features injected as levels) vs human reference.")
    parser.add_argument("--base-dir", type=str, default=None)
    parser.add_argument("--llm", type=str, default="sample_data/sample_sre_sem_level_scores_raw.xlsx")
    ...
    parser.add_argument("--out", type=str, default="sample_outputs/sample_sre_sem_level_reliability_summary.xlsx")
