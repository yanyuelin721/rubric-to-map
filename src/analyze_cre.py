...
Purpose
-------
Analyze CRE (rubric-constrained evaluation) raw VLM scores against human reference scores.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Analyze CRE raw VLM scores vs human reference.")
    parser.add_argument("--base-dir", type=str, default=None, help="Project root (optional).")
    parser.add_argument("--llm", type=str, default="sample_data/sample_cre_scores_raw.xlsx", help="LLM raw CRE results.")
    ...
    parser.add_argument("--out", type=str, default="sample_outputs/sample_cre_reliability_summary.xlsx", help="Output Excel path.")
