...
Example
-------
python src/run_cre_scoring.py \
  --images sample_data/sample_images \
  --out sample_outputs/sample_cre_scores_raw.xlsx \
...
DEFAULT_OUT = "sample_outputs/sample_cre_scores_raw.xlsx"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run CRE scoring on a folder of images.")
    ...
    pbar = tqdm(total=len(jobs), desc="CRE jobs", ncols=90) if args.progress_bar else None
