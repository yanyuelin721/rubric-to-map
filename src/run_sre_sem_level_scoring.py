# -*- coding: utf-8 -*-
"""
run_sre_sem_level_scoring.py

Run the SRE-Sem-Level variant: image-based scoring with semantic features
...
DEFAULT_OUT = "sample_outputs/sample_sre_sem_level_scores_raw.xlsx"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the SRE-Sem-Level scoring variant on a folder of images.")
    ...
    pbar = tqdm(total=len(jobs), desc="SRE-Sem-Level jobs", ncols=90) if args.progress_bar else None
