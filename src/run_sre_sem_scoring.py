# -*- coding: utf-8 -*-
"""
run_sre_sem_scoring.py

Run the SRE-Sem variant: image-based scoring with additional numeric semantic
...
DEFAULT_OUT = "sample_outputs/sample_sre_sem_scores_raw.xlsx"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the SRE-Sem scoring variant on a folder of images.")
    ...
    pbar = tqdm(total=len(jobs), desc="SRE-Sem jobs", ncols=90) if args.progress_bar else None
