...
Purpose
-------
Analyze CRE-Sem raw VLM scores (prompt includes semantic features) vs human reference.

Example
-------
python src/analyze_cre_sem.py \
  --llm sample_data/sample_cre_sem_scores_raw.xlsx \
  --human sample_data/sample_human_ratings.xlsx \
  --out sample_outputs/sample_cre_sem_reliability_summary.xlsx
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Analyze CRE-Sem raw VLM scores (prompt includes semantic features) vs human reference.")
    parser.add_argument("--base-dir", type=str, default=None)
    parser.add_argument("--llm", type=str, default="sample_data/sample_cre_sem_scores_raw.xlsx")
    ...
    parser.add_argument("--out", type=str, default="sample_outputs/sample_cre_sem_reliability_summary.xlsx")
